...
class Transactions extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Switch thumbColor={this.state.switch?'#174285':'white'} trackColor={{'false':'#D6DCE0' ,'true':'#D6DCE0'}} value={this.state.switch} onValueChange={val=>this.setState({switch:val})}/>
      </View>
    );
  }
}
