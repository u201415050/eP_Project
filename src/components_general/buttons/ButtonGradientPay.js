...
class ButtonGradientPay extends Component {
  state = {
    clicks: 0,
          ...
          {cant && this.state.clicks > 0 ? (
              <View
                  style={{
                    ...
                    borderRadius: hp('2%'),
                    elevation:4,
                    paddingHorizontal: this.state.orientation ? wp('1.5%') : wp('0.6%'),
                  }}
              >
...
export default ButtonGradientPay;
